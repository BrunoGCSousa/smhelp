<?php if($paginator->hasPages()): ?>
    <div class="ui pagination menu" role="navigation">
        ...
        <?php else: ?>
            <a class="icon item" href="<?php echo e($paginator->previousPageUrl(), false); ?>" rel="prev" aria-label="<?php echo app('translator')->getFromJson('pagination.previous'); ?>"> <i class="left chevron icon"></i> </a>
        <?php endif; ?>
        ...
        <?php if($paginator->hasMorePages()): ?>
            <a class="icon item" href="<?php echo e($paginator->nextPageUrl(), false); ?>" rel="next" aria-label="<?php echo app('translator')->getFromJson('pagination.next'); ?>"> <i class="right chevron icon"></i> </a>
        <?php else: ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\Bruno\Downloads\chatty-app-code\smhelp.wuaze.com\vendor\laravel\framework\src\Illuminate\Pagination\resources\views\semantic-ui.blade.php ENDPATH**/ ?>